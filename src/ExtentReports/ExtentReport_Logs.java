...
public class ExtentReport_Logs 
{
	...
	public void startReport()
	{
		...
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir")+"/resources/logs/ExtentReports/ExtentReport_Logs_"+dateFormat.format(date)+".html");
